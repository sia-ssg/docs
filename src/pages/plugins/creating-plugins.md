...
description: "Learn how to create plugins for Sia, both locally and as npm packages"
order: 50
...
- [Plugin Hooks](/plugins/hooks/) - Complete hook reference
- [Plugin API](/plugins/api/) - API utilities available to plugins
- [Plugin Configuration](/plugins/configuration/) - Configuration options
- [Plugin Structure](/plugins/structure/) - Plugin structure and discovery
